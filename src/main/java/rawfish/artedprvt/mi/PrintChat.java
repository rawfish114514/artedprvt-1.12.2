...
public class PrintChat implements ScriptObject{
    ...
    public void line(String chat,int id){
        ...
        info(chat);
        guiNewChat.printChatMessageWithOptionalDeletion(new TextComponentString(chat),id);
    }
    ...
    public void line(String chat,String hover,int id){
        ...
        info(chat);
        TextComponentString chatComponentText=new TextComponentString(chat);
        TextComponentString hoverComponent=new TextComponentString(hover);
        chatComponentText.setStyle(new Style()
                .setHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT,hoverComponent))
                .setClickEvent(new CopyEvent(hoverComponent))
        );
    ...
    public void line(String chat,ChatProvider hover,int id){
        ...
        info(chat);
        TextComponentString chatComponentText=new TextComponentString(chat);
        TextComponentString hoverComponent=new ChatProviderComponent(hover);
        chatComponentText.setStyle(new Style()
                .setHoverEvent(new HoverEvent(HoverEvent.Action.SHOW_TEXT,hoverComponent))
                .setClickEvent(new CopyEvent(hoverComponent))
        );
    ...
    public static class ChatProviderComponent extends TextComponentString implements ScriptObject {
    ...
    public static class CopyEvent extends ClickEvent {
        ...
        public CopyEvent(TextComponentString chatComponents) {
            super(null, null);
